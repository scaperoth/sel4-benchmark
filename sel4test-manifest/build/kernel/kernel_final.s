...
#APP
# 35 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/include/arch/ia32/arch/machine/cpu_registers.h" 1
	movl %edx, %cr3
# 0 "" 2
#NO_APP
.L19:
...
.L24:
	...
	movl	(%eax), %eax
#APP
# 233 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/src/arch/ia32/fastpath/fastpath.c" 1
	                movl %ecx, %esp 
                popl %edi 
                popl %ebp 
                popl %ds 
...
.L33:
	...
	movl	(%eax), %eax
#APP
# 210 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/src/arch/ia32/fastpath/fastpath.c" 1
	                movl %ecx, %esp 
                popl %edi 
                popl %ebp 
                addl $8, %esp 
...
.L32:
#APP
# 41 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/include/arch/ia32/arch/machine/cpu_registers.h" 1
	movl %cr0, %ecx
# 0 "" 2
#NO_APP
	orl	$8, %ecx
#APP
# 47 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/include/arch/ia32/arch/machine/cpu_registers.h" 1
	movl %ecx, %cr0
# 0 "" 2
#NO_APP
	jmp	.L23
.L31:
#APP
# 45 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/include/arch/ia32/arch/machine/fpu.h" 1
	clts
# 0 "" 2
#NO_APP
	.p2align 4,,3
...
.L261:
	...
	andl	$-513, 64(%eax)
#APP
# 37 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/src/arch/ia32/c_traps.c" 1
	movl %eax, %esp
popl %eax
popl %ebx
addl $8, %esp
...
.L262:
#APP
# 89 "/home/mscapero/Desktop/sel4-benchmark/sel4test-manifest/kernel/src/arch/ia32/c_traps.c" 1
	movl %eax, %esp
popl %eax
popl %ebx
popl %ecx
