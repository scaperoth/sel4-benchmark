#ifndef _HOME_MSCAPERO_DESKTOP_SEL4_BENCHMARK_SEL4TEST_MANIFEST_BUILD_IA32_PC99_LIBSEL4_INCLUDE_SEL4_TYPES_GEN_H
#define _HOME_MSCAPERO_DESKTOP_SEL4_BENCHMARK_SEL4TEST_MANIFEST_BUILD_IA32_PC99_LIBSEL4_INCLUDE_SEL4_TYPES_GEN_H
...
/* fail if user has passed bits that we will override */
    assert((seL4_CapData_Badge & ~0x1) == 0);
...
/* fail if user has passed bits that we will override */
    assert((seL4_CapData_Guard & ~0x1) == 0);
